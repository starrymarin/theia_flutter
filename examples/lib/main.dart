  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Theia(
        ...
        nodePlugins: [
          NodePlugin("table", (nodeJson) => TableNode(nodeJson)),
          NodePlugin("table-row", (nodeJson) => TableRowNode(nodeJson)),
          NodePlugin("table-cell", (nodeJson) => TableCellNode(nodeJson)),
          NodePlugin("date", (nodeJson) => DateNode(nodeJson))
        ],
      ),
    );
  }
